...
const ITEM_CATEGORIES = {
  ...
  दूध: 'dairy', अंडे: 'dairy', अंडा: 'dairy', पनीर: 'dairy', दही: 'dairy',
  घी: 'dairy', मक्खन: 'dairy', क्रीम: 'dairy',
  ब्रेड: 'bakery', पाव: 'bakery', बन: 'bakery', रोटी: 'bakery',
  चावल: 'pantry', आटा: 'pantry', मैदा: 'pantry', सूजी: 'pantry',
  बेसन: 'pantry', पोहा: 'pantry', दाल: 'pantry', राजमा: 'pantry',
  चना: 'pantry', मैगी: 'pantry', नूडल्स: 'pantry', चीनी: 'pantry',
  नमक: 'pantry', तेल: 'pantry', मसाला: 'pantry', जीरा: 'pantry',
  हल्दी: 'pantry', धनिया: 'pantry', अचार: 'pantry', शक्कर: 'pantry',
  सेब: 'produce', केला: 'produce', केले: 'produce', प्याज: 'produce',
  आलू: 'produce', टमाटर: 'produce', गाजर: 'produce', मटर: 'produce',
  भिंडी: 'produce', बैंगन: 'produce', गोभी: 'produce', पालक: 'produce',
  नींबू: 'produce', अदरक: 'produce', लहसुन: 'produce', संतरा: 'produce',
  आम: 'produce', अंगूर: 'produce', खीरा: 'produce',
  मुर्गी: 'meat', चिकन: 'meat', मछली: 'meat', मटन: 'meat',
  कुरकुरे: 'snacks', नमकीन: 'snacks', बिस्किट: 'snacks', चॉकलेट: 'snacks',
  मिठाई: 'snacks', चिप्स: 'snacks',
  पानी: 'beverages', चाय: 'beverages', कॉफी: 'beverages', जूस: 'beverages',
  लस्सी: 'beverages', 'नारियल पानी': 'beverages',
  साबुन: 'household', डिटर्जेंट: 'household', 'टॉयलेट पेपर': 'household',
  शैम्पू: 'personal', टूथपेस्ट: 'personal', 'टूथ ब्रश': 'personal',
